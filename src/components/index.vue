<template>
    <div>
        ...
        <div id="control1">
            <div class="ol-control" style=" top:100px!important;left: 9px!important; ">
            ...
            <div class="ol-control" style=" top:125px!important;left: 9px!important;">
            ...
            <div class="ol-control" style=" top:150px!important;left: 9px!important;">
            ...
            <div class="search-container" v-if="searchVisible">
                ...
                <select class="website-select">
                    ...
                    <option value="site1">网站1</option>
                    <option value="site2">网站2</option>
                    <!-- 添加更多选项 -->
                </select>
                <button class="search-button">搜索</button>
                <button class="show-map-button">显示到地图</button>
            </div>
    ...
    methods: {
        ...
        handleNodeClick(data) {
            if (data.latitude) {
                ...
                const zoomLevel = 15; // 缩放级别，可以根据需要进行调整
                window.map.getView().animate({ // 只设置需要的属性即可
                    center: olProj.fromLonLat([longitude, latitude]), // 中心点
                    zoom: zoomLevel, // 缩放级别
                    rotation: undefined, // 缩放完成view视图旋转弧度
